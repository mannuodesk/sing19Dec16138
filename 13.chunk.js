...
var Generic = (function () {
    ...
    Generic.prototype.updateTitleTextCard = function (responseMessageId) {
        this._botTrainingService.updateTitleText(responseMessageId, jQuery('#textCardTitle' + responseMessageId).val()).subscribe(function (a) {
            if (a.code == 200) {
    ...
    Generic.prototype.populateGalleryImage = function (event, responseMessageId, blockId) {
        var _this = this;
        var file = event.target.files[0];
        this._botTrainingService.getPictureUrl(file, responseMessageId).subscribe(function (a) {
            if (a.code == 200) {
    ...
    Generic.prototype.addGalleryCard = function () {
        ...
        /*this.card = new Card("gallery", this.galleryCard);
            this._botTrainingService.addResponseMessage(this.galleryCard,"gallery",this.popBlock._id).subscribe(
                    a=> {
                        if(a.code == 200)
                        {
                            this.cardArray.push(a.data);
                        }
                    }
                );*/
    };
                ...
                for (var i = 0; i < _this.blockGroupsModel.length; i++) {
                    for (var j = 0; j < _this.blockGroupsModel[i].blocks.length; j++) {
                        if (_this.blockGroupsModel[i].blocks[j]._id == Id) {
                            _this.blockGroupsModel[i].blocks.splice(j);
                            break;
                        }
                    }
                }
...
var BotTrainingService = (function () {
    ...
    BotTrainingService.prototype.updateTitleText = function (Id, Text) {
        return this.http.get(this.baseUrl + 'responsemessage/updateTitle/' + Id + '/' + Text)
            .map(function (res) { return res.json(); });
    };
    ...
    BotTrainingService.prototype.getPictureUrl = function (file, Id) {
